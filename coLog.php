    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Company Login</strong></h3>
            
        </div>
<center>
<form name="frmReg" action="coLog.php" method="post">
...
<td>
<td> Username : </td>
<td><input type= "text" name="coUsername" class="form-control"></td>
</td>
</tr>
<br></br>
<tr>
<td>
<td> Password : </td>
<td><input type="password" name="coPass" class="form-control"></td>
</td>
</tr>
</tbody>
</table><br><br>
<input name="co_log" value="Login" type="submit" class="btn btn-success display-4">
<br><br><br>
