...
<center>
<form name="frmReg" method="post" action="custReg.php">
...
<td><input name="fName" class="form-control" required="" 
    value="<?php echo $fName?>"></td>
</tr>
<tr>
<td>
</td><td> Last Name : </td>
<td><input name="lName" class="form-control" required=""
    value="<?php echo $lName?>"></td>
</tr>
<tr>
<td>
</td><td> Username : </td>
<td><input name="username" class="form-control" required="" value="<?php echo $username?>"></td>
</tr>
<tr>
<td>
</td><td> Phone Number : </td>
<td><input name="custTelNo" class="form-control" required=""value="<?php echo $custTelNo?>"></td>
</tr>
<tr>
<td>
</td><td> Email : </td>
<td><input type="email" name="custEmail" class="form-control"required="" value="<?php echo $custEmail?>"></td>
</tr>
<tr>
<td>
</td><td> Password : </td>
<td><input type="password" name="custPass" class="form-control"  required="" value="<?php echo $custPass?>">
</td>
</tr>
<tr>
<td>
