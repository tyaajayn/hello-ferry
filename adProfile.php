        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                    ...
                    <li class="nav-item"><a class="nav-link link text-white text-primary display-4" href="adLog.php">Logout</a></li></ul>
            </div>
        </div>
    </nav>
</section>
...
<section class="form5 cid-sn1Q6oEwoi" id="form5-17">
        ...
        while ($row = $result->fetch_assoc())
          {
            ...
            echo "</tr>";
            echo "<tr>"; 
            echo "<td><th>Phone Number : </th></td>"; echo "<td>"; echo $row["adTelNo"]; echo "</td>"; 
            echo "</tr>";
            echo "<tr>"; 
    ...
    <label for="adWorkPlace"><b>Work Place</b></label>
    ...
    <label for="adComp"><b>Company</b></label>
   <select name="adComp">
    ...
    <input type="password" name="oldPass" class="form-control"><br>
