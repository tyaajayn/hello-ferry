    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Admin Login</strong></h3>
            
        </div>
<center>
<form name="frmReg" action="adLog.php" method="post">
...
<td>
<td> Username : </td>
<td><input type= "text" name="adUsername" class="form-control"></td>
</td>
</tr>
<br></br>
<tr>
<td>
<td> Password : </td>
<td><input type="password" name="adPass" class="form-control"></td>
</td>
</tr>
</tbody>
</table><br><br>
<input name="ad_log" value="Login" type="submit" class="btn btn-success display-4">
<br><br><br>
<p>Not a user? Register now!</p>
<p><a href="coReg.php">Company</a> || <a href="custReg.php">Customer</a></p>
<br>
<p>Have an account? Log in now!</p>
<p><a href="coLog.php">Company</a> || <a href="custLog.php">Customer</a></p>
</form>
</center>
</section>
